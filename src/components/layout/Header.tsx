...
export function Header() {
  ...
  const [notifications] = useState([
    { id: 1, message: "5 critical results pending approval", type: "urgent" },
    { id: 2, message: "Equipment calibration due tomorrow", type: "warning" },
    { id: 3, message: "Monthly report ready for review", type: "info" }
  ]);
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex-1 max-w-md">
          <div className="relative">
            ...
            <Input
              type="search"
              placeholder="Search patients, samples, tests..."
              className="pl-10 bg-gray-50"
            />
          </div>
        </div>

        {/* Right side - Notifications, Quick Actions, Profile */}
